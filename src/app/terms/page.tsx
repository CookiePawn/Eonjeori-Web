...
const sections = [
  ...
  {
    title: "데이터 출처",
    body: "언저리는 국토교통부 실거래가공개시스템 자료를 활용합니다. 지원 URL은 https://rt.molit.go.kr/pt/xls/xls.do 입니다. 언저리 서비스는 정부앱이 아닌 개인 개발 서비스입니다. 해당 데이터는 국토교통부에서 제공하는 공식 데이터를 활용하여 최대한 의미 있는 정보를 제공하기 위해 사용됩니다.",
  },
  {
    title: "사용자의 책임",
